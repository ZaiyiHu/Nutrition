...
def main(args,i,ticks):
    ...
    train_json_file = '/disk/btc010001/ECUSTFD/data/ECUSTFD_equal-interval_oversampling679_'+i+'_train.json'
    test_json_file = '/disk/btc010001/ECUSTFD/data/ECUSTFD_equal-interval_oversampling679_'+i+'_test.json'
    # equal-amount
    ...
    # # equal-interval
    train_anchor = [(26.0, 68.2, 47.1), (68.2, 110.4, 89.3), (110.4, 152.6, 131.5), (152.6, 194.8, 173.7),
    ...
    for iepoch in range(epoch):
        ...
        if tmp_error<food_MAE_pre:
            ...
            df.to_excel('/disk/btc010001/ECUSTFD/result/'+ticks+'seed'+str(seed)+ 'volume(mm^3)' +'.xlsx', index=True)
...
if __name__ == '__main__':
    ...
    print(ticks)
    root_dir = '/disk/btc010001/ECUSTFD/code/..'
    res_dir = '/disk/btc010001/ECUSTFD/code/../ckpt/ecustfd/'+ ticks +'volume_imp_code'
