...
def calMAE(pre_res,tmp):
    ...
    groundtruth_csv_path = '/disk/btc010001/ECUSTFD/data/'+tmp+'_test_gt.csv'  # sys.argv[1]
    ...
    xls_reader = ReadExcel('/disk/btc010001/ECUSTFD/ECUSTFD-resized--master/density.xls')
    ...
    volume_dict = {}
    # for idx in range(0,len(pre_res)):
...
if __name__ == '__main__':
    #'/disk/btc010001/ECUSTFD/result/2021-10-14 16:28weight(g)_prediction.csv'
